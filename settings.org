...
#+begin_src emacs-lisp
    ...
    (global-set-key "`" 'aqr-map)
    (define-key aqr-map (kbd "s") 'isearch-forward)
    ...
    (global-set-key (kbd "C-k") 'avy-kill-whole-line)
...
#+BEGIN_SRC emacs-lisp
  ...
  (key-chord-define-global "qq" 'aqr-map)
